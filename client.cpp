...
void * send_thread( void * arg )
{
    ...
    std::cout << terminal::TEXT_BOLD << terminal::TEXTCOLOR_YELLOW <<  "Hey there Space Cowboy, you just joined JChat...." << std::endl; 

    std::cout << "What's your Handle??: " << terminal::TEXT_BOLD << terminal::TEXTCOLOR_CYAN;
